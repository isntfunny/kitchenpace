...
export function MobileView({
    ...
    const handStatusMessage = (() => {
        if (lastGesture === 'swipeLeft') {
            return '⬅️ Swipe erkannt: Weiter';
        }
        if (lastGesture === 'swipeRight') {
            return '➡️ Swipe erkannt: Zurück';
        }
        switch (handStatus) {
            case 'loading':
                return 'Handlandmarker wird bereitgestellt…';
            case 'running':
                return 'Kamera läuft. Wische mit der Hand nach links/rechts.';
            case 'success':
